...
from smartadata_loader import data
from smartamodel import predict_tweet_sentiment
from smartapreprocessing import preprocess_text, analyze_sentiment_with_adjectives
